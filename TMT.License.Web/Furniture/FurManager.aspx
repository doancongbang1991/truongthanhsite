<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FurManager.aspx.cs" Inherits="TMT.License.Web.License.FurManager" %>
...
<body>
                    ...
                    <ext:GridPanel ID="grPosition" SelectionMemory="false" runat="server" Region="East" 
                        ...
                        <Store>
                            <ext:Store ID="stPosition" runat="server" AutoDestroy="true" >
                                <Model>
                                    <ext:Model ID="mdPosition" runat="server" IDProperty="FurID" Name="Session">
                                        <Fields>
                                            <ext:ModelField Name="FurID" />
                                            <ext:ModelField Name="FurName" />
                                            <ext:ModelField Name="FurDetail" />
                                            <ext:ModelField Name="FurTypeID" />
                                            <ext:ModelField Name="FurImg" />
                                            <ext:ModelField Name="FurTypeName" />
                                        </Fields>
                                    </ext:Model>
                                </Model>
                                <Listeners>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="colFurID" runat="server" DataIndex="FurID" Text="ID" Flex="10" Hidden="true"/>
                                <ext:Column ID="colFurName" runat="server" DataIndex="FurName" Text="Name"  Flex="10"  />
                                <ext:Column ID="colFurDetail" runat="server" DataIndex="FurDetail" Text="Detail" Flex="15" />
                                <ext:Column ID="colFurTypeID" runat="server" DataIndex="FurTypeID" Text="Type"  Flex="10"  Hidden="true"/>
                                <ext:Column ID="ColFurTypeName" runat="server" DataIndex="FurTypeName" Text="Type"  Flex="10"  />
                                <ext:Column ID="colFurImg" runat="server" DataIndex="FurImg" Text="Img" Flex="15" />
                                </Columns>
                        </ColumnModel>
                        <View>
    ...
    <ext:Window ID="winDetails" runat="server" Hidden="true" Closable="false" Resizable="false"
        Height="285" Icon="ApplicationFormEdit" Title="Furniture Manager" Draggable="true" Width="510"
            ...
            <ext:FieldSet ID="FieldSet5" Border="false" Width="500" Height="275" runat="server"
                ...
                <Items>
                   <ext:TextField ID="hiID" runat="server" Hidden="true" />
                    ...
                    <ext:TextField ID="txtFurName" runat="server" FieldLabel="Furniture Name" />
                    <ext:TextField ID="txtFurDetail" runat="server" FieldLabel="Fureniture Detail"/>
                    <ext:ComboBox ID="cbbFurType" runat="server" TypeAhead="true" QueryMode="Local" ForceSelection="true"
                        Editable="false" TriggerAction="All" FieldLabel="Fur. Type" DisplayField="FurTypeName"
                        ValueField="FurTypeID">
                        <Store>
                    ...
                    <ext:TextField ID="txtFurImg" runat="server" FieldLabel="Furniture Image"  />
                </Items>
            </ext:FieldSet>
        </Items>
        <Buttons>
