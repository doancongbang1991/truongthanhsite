                    ...
                    <ext:GridPanel ID="grPosition" SelectionMemory="false" runat="server" Region="East" 
                                ...
                                <Model>
                                    <ext:Model ID="mdPosition" runat="server" IDProperty="ArchID" Name="Session">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="ArchDetail" />
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="colArchDetail" runat="server" DataIndex="ArchDetail" Text="Detail" Flex="15" />
                                </Columns>
                        </ColumnModel>
                        <View>
            ...
            <ext:FieldSet ID="FieldSet5" Border="false" Width="500" Height="275" runat="server"
                ...
                <Items>
                   <ext:TextField ID="hiID" runat="server" Hidden="true" />
                    <ext:TextField ID="txtArchName" runat="server" FieldLabel="Arch Name" />
                    <ext:TextArea ID="txtArchDetail" runat="server" FieldLabel="Arch Detail" Height ="180" />
