<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArchManager.aspx.cs" Inherits="TMT.License.Web.License.ArchManager" %>
<!DOCTYPE html>
...
<body>
    <form id="Form1" runat="server">
                        ...
                        <ext:GridPanel ID="grPosition" SelectionMemory="false" runat="server" Region="East"
                            ...
                            <Store>
                                <ext:Store ID="stPosition" runat="server" AutoDestroy="true">
                                    <Model>
                                        <ext:Model ID="mdPosition" runat="server" IDProperty="ArchID" Name="Session">
                                            <Fields>
                                                <ext:ModelField Name="ArchID" />
                                                <ext:ModelField Name="ArchName" />
                                                <ext:ModelField Name="ArchTypeName" />
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="colArchID" runat="server" DataIndex="ArchID" Text="ID" Flex="10" Hidden="true" />
                                    <ext:Column ID="colArchName" runat="server" DataIndex="ArchName" Text="Name" Flex="10" />
                                    <ext:Column ID="colArchTypeName" runat="server" DataIndex="ArchTypeName" Text="Type" Flex="15" />
                                </Columns>
                            </ColumnModel>
                            <View>
        ...
        <ext:Window ID="winDetails" runat="server" Hidden="true" Closable="false" Resizable="false"
            Height="500" Width="800" Icon="ApplicationFormEdit" Title="Arch Manager" Draggable="true" Maximizable="true" Collapsible="true"
            Modal="true" BodyPadding="5" Layout="FitLayout">
            <Items>
                <ext:FieldContainer ID="Fieldcontain" Border="false" runat="server"
                    Anchor="100%" Padding="5" Layout="AnchorLayout" DefaultAnchor="100%">
                    <Items>
                        <ext:Panel ID="pnlInfo" runat="server" Layout="AnchorLayout" Region="Center" DefaultAnchor="100%" Flex="1" Title="Thông Tin Liên Hệ">
                            <Items>
                                <ext:TextField ID="hiID" runat="server" Hidden="true" />
                                <ext:TextField ID="txtArchName" runat="server" FieldLabel="Arch Name" AnchorHorizontal="100%" />
                                <ext:TextField ID="txtArchThump" runat="server" FieldLabel="Arch Thump" />
                                <ext:ComboBox ID="cbbArchType" runat="server" TypeAhead="true" QueryMode="Local" ForceSelection="true"
                                    Editable="false" TriggerAction="All" FieldLabel="Arch. Type" DisplayField="ArchTypeName"
                                    ValueField="ArchTypeID">
                                    <Store>
                                        <ext:Store ID="stcbbPID" runat="server">
                                            <Model>
                                                <ext:Model ID="Model1" runat="server">
                                                    <Fields>
                                                        <ext:ModelField Name="ArchTypeID" />
                                                        <ext:ModelField Name="ArchTypeName" />
                                                    </Fields>
                                                </ext:Model>
                                            </Model>
