...
$(document).ready(function(){
	...
	var blue = "#14CCCC"
		...
		function wpgmappity_maps_loaded() {
			...
			var latlng = new google.maps.LatLng(10.79733,106.67846); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		var styles = [
			{
		...
		var point0 = new google.maps.LatLng(10.79733,106.67846); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		...
		google.maps.event.addListener(marker0,'click',
		 ...
		 {content: 'Công Ty TNHH Trường Thành\n116 Nguyen Trong Tuyen Street, Phu Nhuan District'});
