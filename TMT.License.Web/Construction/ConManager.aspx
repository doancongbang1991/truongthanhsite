<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConManager.aspx.cs" Inherits="TMT.License.Web.License.ConManager" %>
...
<body>
                    ...
                    <ext:GridPanel ID="grPosition" SelectionMemory="false" runat="server" Region="East" 
                        ...
                        <Store>
                            <ext:Store ID="stPosition" runat="server" AutoDestroy="true" >
                                <Model>
                                    <ext:Model ID="mdPosition" runat="server" IDProperty="ConID" Name="Session">
                                        <Fields>
                                            <ext:ModelField Name="ConID" />
                                            <ext:ModelField Name="ConName" />
                                            <ext:ModelField Name="ConDetail" />
                                            <ext:ModelField Name="ConTypeID" />
                                            <ext:ModelField Name="ConImg" />
                                            <ext:ModelField Name="ConTypeName" />
                                        </Fields>
                                    </ext:Model>
                                </Model>
                                <Listeners>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="colConID" runat="server" DataIndex="ConID" Text="ID" Flex="10" Hidden="true"/>
                                <ext:Column ID="colConName" runat="server" DataIndex="ConName" Text="Name"  Flex="10"  />
                                <ext:Column ID="colConDetail" runat="server" DataIndex="ConDetail" Text="Detail" Flex="15" />
                                <ext:Column ID="colConTypeID" runat="server" DataIndex="ConTypeID" Text="Type"  Flex="10"  Hidden="true"/>
                                <ext:Column ID="ColConTypeName" runat="server" DataIndex="ConTypeName" Text="Type"  Flex="10"  />
                                <ext:Column ID="colConImg" runat="server" DataIndex="ConImg" Text="Img" Flex="15" />
                                </Columns>
                        </ColumnModel>
                        <View>
    ...
    <ext:Window ID="winDetails" runat="server" Hidden="true" Closable="false" Resizable="false"
        Height="285" Icon="ApplicationFormEdit" Title="Construction Manager" Draggable="true" Width="510"
            ...
            <ext:FieldSet ID="FieldSet5" Border="false" Width="500" Height="275" runat="server"
                ...
                <Items>
                   <ext:TextField ID="hiID" runat="server" Hidden="true" />
                    ...
                    <ext:TextField ID="txtConName" runat="server" FieldLabel="Construction Name" />
                    <ext:TextField ID="txtConDetail" runat="server" FieldLabel="Construction Detail"/>
                    <ext:TextField ID="txtConImg" runat="server" FieldLabel="Construction Image" Text=""/>
                    <ext:ComboBox ID="cbbConType" runat="server" TypeAhead="true" QueryMode="Local" ForceSelection="true"
                        Editable="false" TriggerAction="All" FieldLabel="Con. Type" DisplayField="ConTypeName"
                        ValueField="ConTypeID">
                        <Store>
